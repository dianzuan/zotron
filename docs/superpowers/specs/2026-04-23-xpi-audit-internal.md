# XPI Internal Consistency Audit — 2026-04-23

Shape / params / error-pattern scan of all 77 RPC methods across 9
families. Row format defined in `2026-04-23-xpi-api-audit-design.md`.
